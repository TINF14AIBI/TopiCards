...
\begin{wrapfigure}{r}{0.4\linewidth}
  ...
  \begin{center}
  	\hspace{-20pt}
    \includegraphics[width=0.7\linewidth]{Kapitel/Iridium/Grafiken/logo.jpg}
  \end{center}
  \vspace{-15pt}
\end{wrapfigure}
...
\begin{Figure}
\includegraphics[width=\linewidth]{Kapitel/Iridium/Grafiken/bild2_dhbw.jpg}
...
\begin{Figure}
\includegraphics[width=\linewidth]{Kapitel/Iridium/Grafiken/sg_ft_zemath.png}
...
\includegraphics[width=\textwidth]{Kapitel/Iridium/Grafiken/Zeitstrahl}
\par
\noindent
